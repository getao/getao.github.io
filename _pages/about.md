...
1. **Speculative Decoding**: Tao was **the first** to propose and name Speculative Decoding in the published literature, a novel paradigm for lossless acceleration of Transformer decoding, and **the first** to [open-source](https://github.com/microsoft/unilm/tree/master/decoding/GAD) the draft-then-verify speculative execution decoding paradigm:
