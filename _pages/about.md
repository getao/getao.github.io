...
- **Speculative Decoding: Exploiting Draft-then-Verify for Accelerating Seq2seq Generation**
  ...
  To appear in Findings of **EMNLP 2023** (Originally announced in March 2022: https://arxiv.org/abs/2203.16487, **the first work proposing Speculative Decoding** that introduces an independent draft model to accelerate generation explicitly with the idea of speculative execution)
